       ...
       <p>회원 정보를 작성해주세요.</p>
        ...
        <form id="Login" action="member_join.php" method="post">
            ...
            <div class="form-group">
                ...
                <span class="Logo"style="width:60% "><input style="margint-right:0px" type="text" class="form-control" id = "usr" name="id" placeholder="ID"></span>
            </div>

            <div class="form-group">
                <span class="Logo" style="width:30%"><label for="pw" style="margin-right :10px">Password </label></span>
                <span class="Logo" style="width:60% "><input type="password" class="form-control" id="pwd" name="pw" placeholder="Password"></span>
